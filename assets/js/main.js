...
h1.style.color = '#a2433f';
document.body.style.backgroundColor = '#a2433f;'
...
let random = Math.floor(Math.random() * 30); // nimmt die commastellen raus mathfloor
...
btn.addEventListener('click', () => {
    ...
    let random = (Math.random() * data.length - 1)
    let randomRound = (Math.floor(random))

    console.log(randomRound);

    img.src = data[randomRound].download_url
